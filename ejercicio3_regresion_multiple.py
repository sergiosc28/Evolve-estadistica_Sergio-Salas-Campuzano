...
"""Calculo de las metricas de evaluación."""
...
def graficar_real_vs_predicho(y_real, y_pred, ruta_salida="output/ej3_predicciones.png"):
    ...
    # Línea perfecta y = """x
    """ Ajustamos los límites de la gráfica para que incluya todos los puntos
    y la línea diagonal se vea completa. """
